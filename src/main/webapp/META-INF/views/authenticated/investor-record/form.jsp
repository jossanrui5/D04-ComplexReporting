...
<acme:form readonly="true">
	...
	<acme:form-textarea code="authenticated.investorRecord.form.label.sector" path="sector"/>
	<acme:form-textarea code="authenticated.investorRecord.form.label.investingStatement" path="investingStatement"/>
	<acme:form-integer code="authenticated.investorRecord.form.label.stars" path="stars" placeholder="-"/>
